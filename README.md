...
This repository contains a suite of **Model Context Protocol (MCP)** toolboxes powered by [Google GenAI Toolbox](https://storage.googleapis.com/genai-toolbox/v0.1.0/index.html). These toolboxes allow Large Language Models (LLMs) and AI agents to safely and securely query, navigate, and reason over structured and semi-structured database/catalog systems.
